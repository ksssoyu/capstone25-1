...
def request_shape(table_info):
    ...
    # table Shape URL = 'http://127.0.0.1:8080/api/test/1/register'
    # table State URL = "http://127.0.0.1:8080/api/room/1/status"
    url = 'http://127.0.0.1:8080/api/room/1/register'
